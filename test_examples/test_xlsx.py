...
col0 = 0
mypath = 'files'
workbook = xlsxwriter.Workbook('%s/test_xlsx_demo.xlsx' % mypath) 
...
# -------------------------------------
# Insert a logo image
worksheet.insert_image(0, 0, '%s/logo.png' % mypath, {'x_scale': 1.1, 'y_scale': 1.1}) 
...
data = [
    ['Rubicon', 'Switch Concepts Limited', 'Google AdExchange', 'Redux Media', 'Heights Media', 'OpenX', 'bRealTime'],
