...
# Created in Nov / Dec 2014 by Lev Selector
"""
...
class MyBunch(dict):
    """
    # class for a simple container which inherits from a dict(),
    ...
    def __repr__(self):
        ...
        """
        ks = sorted([ x for x in self.iterkeys() ])
        if len(ks) <= 0:
            return ""
        ss = "\n"
        len_n_elems = 100
...
def test_avail(container,mem_str):
    """
    # recursive procedure to test if bunch members exist and have true-ish value
    """
